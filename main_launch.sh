...
#Then the analysis of the standard table is made with analyse bash script. Parameters: combination.txt as 
#the table filename input, 1 as the header of the table, and report.html as the html filename output.
# 2 as the hypergeometric value and 10 as the threshold of patients needed to take account of a GVR.
